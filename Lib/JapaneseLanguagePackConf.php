...
namespace Modules\ModuleJapaneseLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleJapaneseLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * JapaneseLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class JapaneseLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-japanese-language-pack';
